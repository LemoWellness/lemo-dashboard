// Phase 2 — device registration plus foreground message handling.
// Does not display a system banner while the dashboard tab/PWA is focused.
...
export function listenForegroundPush() {
  ...
  try {
    ...
    onMessage(messaging, function () {
      // App is focused: leave the system banner off. Phase 1 inbox/bell still updates.
    });
    foregroundBound = true;
  } catch (e) {
    // Messaging may be unsupported in this browser; inbox still works.
  }
}
