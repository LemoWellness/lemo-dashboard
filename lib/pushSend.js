...
const PUBLIC_ORIGIN = 'https://mngmt.lemowellness.com';
...
function absoluteClickUrl(taskId) {
  return PUBLIC_ORIGIN + clickUrl(taskId);
}
...
export async function sendPushForNotification({
  ...
  try {
    response = await adminMessaging.sendEachForMulticast({
      ...
      data,
      webpush: {
        fcmOptions: { link: absoluteClickUrl(taskId) },
      },
      android: {
